...
)}:host([vertical]:not([compact])) ::slotted(:not(:last-child)){margin-bottom:var(
...
--mod-actionbutton-edge-to-text,var(--spectrum-actionbutton-edge-to-text)
)}:host([compact]:not([quiet])[vertical]) ::slotted(:last-child){border-bottom-left-radius:var(
...
)}:host([compact]:not([quiet]):not([vertical])) ::slotted(:last-child){border-bottom-right-radius:var(
--mod-actiongroup-border-radius,var(--spectrum-actiongroup-border-radius)
);border-top-right-radius:var(
--mod-actiongroup-border-radius,var(--spectrum-actiongroup-border-radius)
);margin-bottom:var(
--mod-actiongroup-button-spacing-reset,var(--spectrum-actiongroup-button-spacing-reset)
)}:host([compact]:not([quiet])[vertical]) ::slotted(:nth-child(n)[tabindex="0"]){border-top-left-radius:var(
--mod-actiongroup-border-radius,var(--spectrum-actiongroup-border-radius)
)!important;border-top-right-radius:var(
--mod-actiongroup-border-radius,var(--spectrum-actiongroup-border-radius)
)!important}:host([compact]:not([quiet]):not([vertical])) ::slotted(:nth-child(n)[tabindex="0"]){border-bottom-left-radius:var(
--mod-actiongroup-border-radius,var(--spectrum-actiongroup-border-radius)
);border-top-left-radius:var(
--mod-actiongroup-border-radius,var(--spectrum-actiongroup-border-radius)
)}:host([compact]:not([quiet])[vertical]) ::slotted(:nth-child(n):not([tabindex="0"])){margin:var(
--mod-actiongroup-vertical-spacing-compact,var(--spectrum-actiongroup-vertical-spacing-compact)
) var(
--mod-actiongroup-button-spacing-reset,var(--spectrum-actiongroup-button-spacing-reset)
) var(
--mod-actiongroup-button-spacing-reset,var(--spectrum-actiongroup-button-spacing-reset)
)}:host([compact]:not([quiet]):not([vertical])) ::slotted(:nth-child(n):not([tabindex="0"])){margin-left:var(
