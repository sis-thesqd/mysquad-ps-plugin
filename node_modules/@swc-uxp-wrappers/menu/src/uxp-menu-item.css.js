...
const styles = css`
:host{border-left:var(--spectrum-menu-item-focus-indicator-width) solid transparent;display:flex;flex-direction:row}:host{min-height:var(
...
)}::slotted([slot=icon]){margin-right:var(
--mod-menu-item-label-text-to-visual,var(--spectrum-menu-item-label-text-to-visual)
)}:host(:focus),:host([focused]){border-left:var(--spectrum-menu-item-focus-indicator-width) solid var(--spectrum-menu-item-focus-indicator-color)}
`;
