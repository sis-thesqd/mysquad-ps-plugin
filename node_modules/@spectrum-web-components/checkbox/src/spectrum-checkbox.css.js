...
);display:inline-flex;max-inline-size:100%;min-block-size:var(--mod-checkbox-height,var(--spectrum-checkbox-height));position:relative;vertical-align:top}:host(:hover) #box:before{border-color:var(
