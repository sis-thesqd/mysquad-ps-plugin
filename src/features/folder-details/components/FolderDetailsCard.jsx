      ...
      <div slot="description" class="card-description">
        ...
        <div class="card-meta">
          {taskDetails?.estimate_mins_after > 0 && (
            <span class="description-text">Estimate: {formatEstimate(taskDetails.estimate_mins_after)}</span>
          )}
          {taskDetails?.due_date_after && (
            <span class="description-text">Draft: {formatDate(taskDetails.due_date_after)}</span>
          )}
          {responsibleDept && (
